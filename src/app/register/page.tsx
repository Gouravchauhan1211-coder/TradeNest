    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-20">
        <div className="max-w-md w-full text-center glass p-10 rounded-[2.5rem]">
          ...
          <h2 className="text-2xl font-black mb-4 uppercase">Check Your Email!</h2>
      ...
      <div className="max-w-md w-full glass p-10 rounded-[2.5rem] shadow-2xl shadow-primary/5">
        <div className="text-center mb-10">
          <Link href="/" className="inline-block mb-6">
            <span className="text-2xl font-black tracking-tighter gradient-text uppercase">TradeNest</span>
          </Link>
          <h1 className="text-3xl font-black tracking-tight mb-2 uppercase">Join TradeNest</h1>
          <p className="text-muted-foreground text-sm">Start your journey to elite knowledge today.</p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white border-2 border-border text-foreground font-bold py-4 px-6 rounded-2xl hover:bg-muted hover:border-primary/30 transition-all mb-8 shadow-sm disabled:opacity-60"
        >
        ...
        <div className="relative mb-8">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-white px-4 text-muted-foreground font-bold uppercase tracking-widest">or</span>
          </div>
        </div>
